  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive h-12 bg-white font-medium md:text-base border-black",
        className
      )}
      {...props}
    />
